...
export function wasm_bindgen__convert__closures__invoke0_mut__h1451077085a60ea0(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h0daa1f5f4822e9dd(a: number, b: number, c: number): void;
